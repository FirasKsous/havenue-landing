...
export function FeatureMenuBuilder() {
  ...
  // Background Recipe Builder: parallax separation on scroll (desktop effect)
  ...
  // Foreground Set Menu Builder: slides DOWN-LEFT to reveal behind image (desktop)
      ...
      <div ref={sectionRef} className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-[2fr_3fr] gap-10 lg:gap-14 items-center">
          ...
          <div className="relative lg:-mr-12 xl:-mr-24 lg:min-h-[480px]">
            {/* Primary: Set Menu Builder — front image, shows first on mobile */}
            <motion.div
            ...
            {/* Secondary: Recipe Builder — overlapping card on mobile, absolute behind on desktop */}
            <motion.div
            ...
            >
              <div
                className="rounded-xl overflow-hidden border border-white/25 cursor-pointer"
                style={{
